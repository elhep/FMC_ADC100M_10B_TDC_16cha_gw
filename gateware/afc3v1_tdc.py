...
class AfckTdc(StandaloneBase):
    ...
    def add_design(self):
        FmcAdc100M10b16chaTdc.add_std(self, 1, False, iostd_single, iostd_diff, with_trig=True)
        #FmcAdc100M10b16chaTdc.add_std(self, 2, False, iostd_single, iostd_diff, with_trig=False)
